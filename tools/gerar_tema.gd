...
## Regenerador do tema: monta e salva `snakito_theme.tres` a partir de
## `SnakitoTokens` (tokens.gd).
##
...
func _variacao_painel(tema: Theme, nome: StringName, estilo: StyleBox) -> void:
