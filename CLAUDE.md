...
- [ ] **M2 — Fidelidade ao Claude Design** (reordenado em 11/08): refazer Home (1d+1e), HUD (1h), Pausa (04c), Pós-partida (8c), Desafios (07), Ranking (08) pelos blueprints de `docs/design/Snakito Telas.dc.html`; realinhar onboarding (11a-d); entrega lado-a-lado (screenshot × design) por tela
- [ ] M3 (antigo M2): AdMob, Billing "Remover Anúncios" (+ Loja 09*), sons + daltonismo (+ Configurações 10), analyzer completo, desafios 3–4, EN/ES, publicação
