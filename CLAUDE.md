...
- **Dependem do Rodrigo para o login funcionar:** criar OAuth clients no Google Cloud (Web p/ Supabase + Android com package `com.rodrigowaters.snakito` e SHA-1 do keystore) e habilitar o provider Google no painel do Supabase; aí eu integro o plugin nativo de Sign-In. Restam do M1: consentimento parental <13, exclusão de conta, onboarding sem texto, +3 skins
