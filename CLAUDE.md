...
- **Calibragem pós-playtest do Rodrigo (08/08, "não consegui abater ninguém"):** dois eixos novos de composição — `turbo_bots` (paridade total de turbo torna caça 1v1 impossível; Arcade 1.4, D2 1.3) e `tamanho_teto_bot` (bots se devoram e viram gigantes: 286 em 2 min; D2 usa teto 12, jogador NUNCA tem teto). D2 também: arena 1600², 1 caçador. **Validação (`tools/simular_desafios.gd`):** 2 de 3 estratégias sintéticas CONCLUEM o D2 (27s e 75s); D1 segue saudável (vencível em 3s farmando, parado morre)
